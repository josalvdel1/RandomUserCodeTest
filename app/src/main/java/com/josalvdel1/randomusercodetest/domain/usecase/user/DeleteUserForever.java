...
public class DeleteUserForever extends UseCase<List<User>> {

    private UserRepository userRepository;

    @Inject
    public DeleteUserForever(InteractorExecutor interactorExecutor, MainThread mainThread,
    ...
    public void onExecute(Callback<List<User>> callback, Object... params) {
        try {
            ...
            userRepository.deleteUserForever(user);
            List<User> oldUsers = userRepository.getOldUsers();
            notifySuccess(oldUsers, callback);
        } catch (Exception e) {
